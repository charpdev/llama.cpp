...
static __device__ __forceinline__ float vec_dot_tq3_0_q8_1(
    ...
    // Inter-thread WHT: steps 8,16 via warp shuffle
    // 4 cooperating threads have consecutive lane IDs: (threadIdx.x & ~3) + {0,1,2,3}
    ...
    // Normalize + undo signs + dot with Q8_1
